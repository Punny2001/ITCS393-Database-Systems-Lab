/* Initial SQL Script for Lab 02
     Student ID: 6288102
     Student Name: Krissanapong Palakham
*/
...
ADD CONSTRAINT FK_FriendMembers FOREIGN KEY (FriendMembers)
...
ALTER TABLE myProjects
ADD CONSTRAINT PK_ProjNo_FriendMembers PRIMARY KEY (ProjNo, FriendMembers)

ALTER TABLE myFriends
ADD CONSTRAINT PK_FriendID_Nickname PRIMARY KEY (FriendID, NickName)
